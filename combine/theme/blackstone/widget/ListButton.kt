...
val LocalListButtonTheme = staticCompositionLocalOf { ListButtonTheme.default }

data class ListButtonTheme(
...
fun ListButton(
    ...
    theme: ListButtonTheme = LocalListButtonTheme.current,
