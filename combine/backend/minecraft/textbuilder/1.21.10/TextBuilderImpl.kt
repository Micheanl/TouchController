package top.fifthlight.combine.backend.minecraft.textbuilder.v1_21_10
...
import top.fifthlight.combine.backend.minecraft.text.v1_21_10.toFormatting
import top.fifthlight.combine.backend.minecraft.text.v1_21_10.toMinecraft
import top.fifthlight.combine.backend.minecraft.text.v1_21_10.toVanilla
...
class TextBuilderImpl(
    ...
    override fun style(textStyle: TextStyle, block: TextBuilder.() -> Unit) {
        block(
            TextBuilderImpl(
                text = text,
                style = textStyle.toVanilla().applyTo(style),
            )
        )
    }
