package top.fifthlight.combine.backend.minecraft.render.v1_21_10.mixin;
...
import top.fifthlight.combine.backend.minecraft.render.v1_21_10.extension.SpriteAccessibleGuiGraphics;
...
public abstract class GuiGraphicsMixin implements SubmittableGuiGraphics, SpriteAccessibleGuiGraphics {
    ...
    @Override
    public TextureAtlasSprite combine$getSprite(ResourceLocation Identifier) {
