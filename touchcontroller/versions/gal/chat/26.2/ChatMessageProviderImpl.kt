...
package top.fifthlight.touchcontroller.gal.chat.v26_2
...
import top.fifthlight.touchcontroller.extension.v26_2.ChatComponentWithMessages
...
object ChatMessageProviderImpl : ChatMessageProvider {
    ...
    override fun getMessages(): PersistentList<ChatMessage> =
        (client.gui.hud.chat as ChatComponentWithMessages).`touchcontroller$getMessages`()
            .reversed()
    ...
    override fun sendMessage(message: String) {
        ...
        if (!message.isEmpty()) {
            client.gui.hud.chat.addRecentChat(message);
